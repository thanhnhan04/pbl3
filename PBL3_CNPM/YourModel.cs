...
namespace PBL3_CNPM
{
    public class YourModel
    {
        public static void UpdateDatabase(HttpContext httpContext, string tennv, DateTime ns, string gt, string dc, string sdt, string em, string stk, string bank)
        {
            ...
            string connectionString = "Data Source=DESKTOP-SP2HFDB;Initial Catalog=QUANLYNHANVIENKHACHSAN;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
