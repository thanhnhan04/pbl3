...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MãChứcVụ).HasName("PK_Luong");
        ...
        modelBuilder.Entity<LuongNv>(entity =>
        {
            ...
            entity.Property(e => e.Phạt).HasColumnType("decimal(10, 3)");
            entity.Property(e => e.Thưởng).HasColumnType("decimal(10, 3)");
        ...
        {
            entity.HasKey(e => e.MãPhânQuyền);

            entity.ToTable("Phanquyen");

            entity.Property(e => e.MãPhânQuyền)
                .HasMaxLength(10)
                .HasColumnName("Mã phân quyền");
            entity.Property(e => e.PhânQuyền)
                .HasMaxLength(50)
                .HasColumnName("Phân quyền");
        });

        modelBuilder.Entity<Phongban>(entity =>
        {
            entity.HasKey(e => e.MãPhòngBan);

            entity.ToTable("Phongban");

            entity.Property(e => e.MãPhòngBan)
                .HasMaxLength(10)
                .HasColumnName("Mã phòng ban");
            entity.Property(e => e.MãTrưởngPhòng).HasColumnName("Mã trưởng phòng");
            entity.Property(e => e.TênPhòngBan)
                .HasMaxLength(50)
                .HasColumnName("Tên phòng ban");
        });
